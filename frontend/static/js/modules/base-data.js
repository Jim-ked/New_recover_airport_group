...
function detailAirports(x){
  ...
  const protections=`<ol class="protection-list">${AIRPORT_PROTECTION_MEASURES.map(item=>`<li>${esc(item)}</li>`).join('')}</ol><p class="field-note"></p>`;
